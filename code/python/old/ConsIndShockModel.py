...
class IndShockConsumerType(PerfForesightConsumerType):
    ...
    def construct_lognormal_income_process_unemployment(self):
        ...
        # Add taxrate, labor, and wage together with function which combines those
        ...
        # Add Shocks: IndShockDstn has different form than before.
        # IncShkDstn = IncShkDstn * ([(1 - taxrate) * labor * wage] * len(TranShkCount_list))
        # TranShkMean_Func(taxrate , labor , wage )

        # From apply_flat_income_tax (did not work. IncShkDstn object is different)
        # unemployed_indices = (
        ...
        #                 IncShkDstn_new[t][i][j] = IncShkDstn[t][i][j] * (1 - taxrate[t]) * labor[t] * wage[t]

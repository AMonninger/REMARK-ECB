...
class test_Transition_Matrix_Methods(unittest.TestCase):
    def test_Harmenberg_mtd(self):
        ...
        example1.define_distribution_grid(timestonest = 2)
        ...
        Assets = []
        dstn = vecDstn
        for i in range(example1.T_sim-20):
        ...
        self.assertAlmostEqual(Assets[5][0], 1.195873707462912)
        self.assertAlmostEqual(Assets[10][0], 1.1958737074629542)
        self.assertAlmostEqual(Assets[15][0], 1.1958737074629846)
